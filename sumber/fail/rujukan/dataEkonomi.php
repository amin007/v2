...
#--------------------------------------------------------------------------------------------------
$tajuk['kp2026'] = '#,Kod,Keterangan';
$data['kp2026'] = [
	['','000','000-Penyiasatan Umum'],
	['','101','101-Tanaman'],
	['','103','103-Ternakan'],
	['','104','104-Perhutanan dan Pembalakan'],
	['','105','105-Perikanan'],
	['','200','200-Perlombongan Mineral dan Pengkuarian'],
	['','201','201-Lombong'],
	['','202','202-Kuari'],
	['','203','203-Pasir'],
	['','205','205-Penyiasatan Pembuatan Bulanan'],
	['','205','205-Pembuatan'],
	['','206','206-Pembinaan'],
	['','206','206-Penyiasatan Binaan Suku Tahunan'],
	['','207','207-Perlombongan Minyak Mentah dan Gas Asli'],
	['','301','301-Perkhidmatan Pendidikan'],
	['','302','302-Perkhidmatan Hospital dan Penjagaan Kesihatan'],
	['','303','303-Perkhidmatan Klinik'],
	['','304','304-Perkhidmatan Arkitek, Kejuruteraan, Juruukur Tanah dan Khidmat Perundingan Teknikal dan Lain'],
	['','305','305-Perkhidmatan Perakaunan'],
	['','306','306-Perkhidmatan Guaman'],
	['','307','307-Perkhidmatan Penginapan'],
	['','308','308-Perkhidmatan Aktiviti Hartanah'],
	['','309','309-Aktiviti Kewangan'],
	['','310','310-Aktiviti Wayang Gambar, Video dan Program Televisyen, Rakaman Bunyi dan Aktiviti Penyiaran'],
	['','311','311-Aktiviti Pentadbiran dan Khidmat Sokongan'],
	['','312','312-Pengiklanan'],
	['','313','313-Pengangkutan Laut dan Pinggir Pantai (Syarikat Perkapalan)'],
	['','314','314-Perkhidmatan Bas'],
	['','315','315-Perkhidmatan Teksi, Kereta Sewa dan Limosin (termasuk perkhidmatan tempahan teksi dll.)'],
	['','316','316-Perkhidmatan Agensi Pengembaraan dan Operator Pelancongan'],
	['','317','317-Perkhidmatan Pengangkutan Udara'],
	['','318','318-Perkhidmatan Kargo, Penyimpanan dan Muatan'],
	['','319','319-Perkhidmatan Telekomunikasi'],
	['','320','320-Perkhidmatan Komputer Dan Maklumat'],
	['','321','321-Perkhidmatan Kereta Api'],
	['','322','322-Perkhidmatan Pengangkutan Air Pedalaman'],
	['','323','323-Perkhidmatan Tempat Letak Kereta'],
	['','324','324-Perkhidmatan Operasi Lebuhraya dan Lain-lain'],
	['','325','325-Perkhidmatan Kurier'],
	['','326','326-Penyiasatan Perdagangan Edaran Bulanan (Perdagangan Borong)'],
	['','326','326-Perdagangan Borong'],
	['','327','327-Penyiasatan Perdagangan Edaran Bulanan (Perdagangan Runcit)'],
	['','327','327-Perdagangan Runcit'],
	['','328','328-Makanan dan Minuman'],
	['','329','329-Penyiasatan Perdagangan Edaran Bulanan (Kenderaan Bermotor)'],
	['','329','329-Industri Kenderaan Bermotor'],
	['','330','330-Aktiviti Penerbitan'],
	['','331','331-Perkhidmatan Perundingan Perniagaan dan Pengurusan'],
	['','332','332-Aktiviti Perkhidmatan Persendirian'],
	['','333','333-Pusat Persidangan dan Pertunjukan Perniagaan'],
	['','334','334-Perpustakaan, Muzium dan Kebudayaan Lain'],
	['','335','335-Pusat Sukan, Hiburan dan Rekreasi'],
	['','336','336-Perkhidmatan Veterinar'],
	['','337','337-Perdagangan Borong &amp; Runcit Bulanan'],
	['','337','337-Perdagangan Borong dan Runcit'],
	['','391','391-Pengangkutan Lain'],
	['','392','392-Penyelidikan dan Pembangunan Saintifik'],
	['','393','393-Perkhidmatan Profesional Lain'],
	['','401','401-Penyiasatan Harga Pengeluar - Pengeluaran Tempatan'],
	['','402','402-Penyiasatan Harga Import'],
	['','403','403-Penyiasatan Harga Eksport'],
	['','411','411-Penggunaan ICT dan e-Dagang'],
	['','412','412-Perkhidmatan dan Peralatan Minyak &amp; Gas (OGSE)'],
	['','800','800-Bekalan Elektrik, Gas, Wap dan Pendingin Udara'],
	['','810','810-Bekalan Air, Pembentungan, Pengurusan Sisa dan Aktiviti Pemulihan'],
	['','820','820-Perbankan, Insurans / Takaful, Pajakan Kewangan dan Pemfaktoran'],
	['','840','840-Perkhidmatan Sosial'],
	['','850','850-Perkhidmatan Kesenian,Hiburan dan Rekreasi'],
	['','890','890-Aktiviti Perkhidmatan Lain'],
];
#--------------------------------------------------------------------------------------------------
...
$data['unitKuantitiLampiran16'] = array(
	...
	Array('','Kilogram (Kg)','07',),
	Array('','Tonne/Metric Ton','08'),
	Array('','Joule (J)','16'),
	Array('','Watt (W)','17'),
	Array('','Gigawatt - Hour (Gwh)','18'),
	Array('','Kilowatt Hour (Kwh)','19'),
	Array('','Kilowatt (Kw)','20'),
	Array('','Horsepower (Hp)','21'),
	Array('','Pieces (Pcs)','22'),
	Array('','Number (No)','23'),
	Array('','Pair','25'),
	Array('','Reams','26'),
	...
	Array('','Gross','29'),
	Array('','Carat','30'),
	array('','Kilopieces (K.pcs) (1,000 pieces)','31'),
	array('','Dozen (Doz)','32'),
	Array('','Cone','33'),
	Array('','Gram (G)','34'),
	Array('','Hectolitre','35'),
	Array('','1,000 Sticks','36'),
	Array('','1,000 Number','37'),
	Array('','Croy Ounze (Gold)','38'),
	Array('','Reels','41'),
	Array('','Litres (L)','42'),
	Array('','Metre (M)','43'),
	Array('','Kilometre (Km)','44'),
	array('','Sq. Metre Of 5 m.m','45'),
	array('','Cubic Metre (Cu.m)','46'),
	array('','Sq. Metre (Sq.m)','47'),
	array('','Bobbin','48'),
	array('','Rounds (for ammunition)','49'),
	array('','Drums','50'),
	array('','Column (for newspaper advertisement)','51'),
	array('','T.E.U. (Twenty Equivalent Unit, for truck containers)','52'),
	array('','Giga Joules (Gas)','53'),
	array('','Barrels','54'),
	array('','Mscf (Thousand Standard Cubic Feet)','55'),
	Array('','Unit Of Ten','56'),
	Array('','Unit Of 100 Metres','57'),
	Array('','Unit Of One Hundred','58'),
	Array('','Unit Of One Thousand','59'),
	Array('','Unit Of One Ringgit','60'),
	Array('','Unit','61'),
	Array('','Unit (Pack)','62'),
	Array('','No Unit Of Quantity (N.P.U.)','97'),
);//*/
#--------------------------------------------------------------------------------------------------
...
$data['bezaUntungRugi'] = array(
	...
	array('','POM023','saiz & kualiti bahan/produk  mengikut projek & permintaan pelanggan','size'
	. ' & quality of materials/products according to project & customer requests'),
	array('','POM024','projek belum mula lagi','The project has not started yet'),
	array('','POM025','permintaan dari sektor automotif terhadap cip komputer',
