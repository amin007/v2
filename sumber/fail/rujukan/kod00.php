...
$data['KodNegaraJPN'] = array(
	...
	array('','XX','ANTIGUA &amp; BARBUDA - 93'),
	array('','XX','AFRIKA - 85'),
	array('','XX','ARAB SAUDI - 77'),
	array('','XX','ALBANIA - 92'),
	array('','XX','ARGENTINA - 84'),
	array('','XX','ALGERIA - 85'),
	array('','XX','ARMENIA - 86'),
	array('','XX','AMERICAN SAMOA - 83'),
	array('','XX','ARUBA - 84'),
	array('','XX','AMERIKA UTARA - 91'),
	array('','XX','ASIA PASIFIK - 83'),
	array('','XX','AMERIKA SELATAN - 84'),
	array('','XX','AUSTRALIA - 83'),
	array('','XX','ANDORRA/ANDORA - 93'),
	array('','XX','AUSTRIA - 86'),
	array('','XX','ANGOLA - 85'),
	array('','XX','AZERBAIJAN - 93'),
	array('','XX','ANGUILLA - 84'),
	array('','XX','BAHAMAS - 90'),
	array('','XX','BOSNIA HERZEGOVINA - 92'),
	array('','XX','BAHRAIN - 88'),
	array('','XX','BOTSWANA - 85'),
	array('','XX','BANGLADESH - 79'),
	array('','XX','BOUVET ISLAND - 93'),
	array('','XX','BARBADOS - 90'),
	array('','XX','BRAZIL - 84'),
	array('','XX','BELARUS - 92'),
	array('','XX','BRITAIN - 87'),
	array('','XX','BELGIUM - 86'),
	array('','XX','BRITISH INDIAN OCEAN TERRITORY - 93'),
	array('','XX','BELIZE - 90'),
	array('','XX','BRUNEI - 60'),
	array('','XX','BENIN - 93'),
	array('','XX','BULGARIA - 92'),
	array('','XX','BERMUDA - 93'),
	array('','XX','BURKINA FASO/BURKINA - 93'),
	array('','XX','BHUTAN - 93'),
	array('','XX','BURMA - 64'),
	array('','XX','BOLIVIA - 84'),
	array('','XX','BURUNDI - 85'),
	array('','XX','BORA-BORA - 93'),
	array('','XX','BYELORUSSIA - 92'),
	array('','XX','CAMBODIA - 62'),
	array('','XX','COLOMBIA - 84'),
	array('','XX','CAMEROON - 85'),
	array('','XX','COMOROS - 93'),
	array('','XX','CANADA - 91'),
	array('','XX','CONGO-BRAZZAVILLE - 85'),
	array('','XX','CAPE VERDE - 93'),
	array('','XX','CONGO-KINSHASA - 85'),
	array('','XX','CARIBBEAN - 90'),
	array('','XX','COOK ISLANDS - 83'),
	array('','XX','CAYMAN ISLANDS - 93'),
	array('','XX','COSTA RICA - 90'),
	array('','XX','CENTRAL AFRICAN REPUBLIC - 85'),
	array('','XX','CROATIA - 92'),
	array('','XX','CHAD - 85'),
	array('','XX','CUBA - 90'),
	array('','XX','CHILE - 84'),
	array('','XX','CYPRUS - 86'),
	array('','XX','CHINA - 74'),
	array('','XX','CZECH REPUBLIC - 92'),
	array('','XX','CHRISTMAS ISLAND - 83'),
	array('','XX','CZECHOSLOVAKIA - 92'),
	array('','XX','COCOS(KEELING) ISLANDS - 83'),
	array('','XX','DJIBOUTI - 85'),
	array('','XX','DOMINICA - 90'),
	array('','XX','DEMOCRATIC KAMPUCHE - 62'),
	array('','XX','DAHOMEY - 93'),
	array('','XX','DENMARK - 86'),
	array('','XX','DOMINICAN REPUBLIC - 90'),
	array('','XX','ECUADOR - 84'),
	array('','XX','ESTONIA - 92'),
	array('','XX','EGYPT - 85'),
	array('','XX','ETHIOPIA - 85'),
	array('','XX','EL SALVADOR - 90'),
	array('','XX','EUROPAH - 86'),
	array('','XX','EQUATORIAL GUINEA - 93'),
	array('','XX','ERITREA - 85'),
	array('','XX','FIJI - 83'),
	array('','XX','FAEROE ISLANDS - 86'),
	array('','XX','FRANCE - 86'),
	array('','XX','FINLAND, METROPOLITAN - 86'),
	array('','XX','FINLAND - 86'),
	array('','XX','FRENCH POLYNESIA - 83'),
	array('','XX','FALKLAND ISLANDS - 93'),
	array('','XX','FRENCH SOUTHERN TERRITORIES - 93'),
	array('','XX','FRENCH GUIANA - 84'),
	array('','XX','GABON - 85'),
	array('','XX','GERMANY (DEM.REP) - 86'),
	array('','XX','GAMBIA - 85'),
	array('','XX','GERMANY (FED.REP) - 86'),
	array('','XX','GUINEA - 85'),
	array('','XX','GEORGIA - 92'),
	array('','XX','GUINEA-BISSAU - 93'),
	array('','XX','GIBRALTAR - 93'),
	array('','XX','GHANA - 85'),
	array('','XX','GREAT BRITAIN - 87'),
	array('','XX','GRENADA - 90'),
	array('','XX','GREENLAND - 91'),
	array('','XX','GUYANA - 84'),
	array('','XX','GUADELOUPE - 84'),
	array('','XX','GUATEMALA - 90'),
	array('','XX','GUAM - 83'),
	array('','XX','GREECE - 86'),
	array('','XX','GERMANY - 86'),
	array('','XX','HAITI - 90'),
	array('','XX','HONDURAS - 90'),
	array('','XX','HUNGARY - 92'),
	array('','XX','HONG KONG - 93'),
	array('','XX','HEARD AND MCDONALD ISLANDS - 83'),
	array('','XX','HOLY SEE (VATICAN CITY) - 86'),
	array('','XX','INDONESIA - 61'),
	array('','XX','IVORY COAST - 93'),
	array('','XX','IRAN - 88'),
	array('','XX','ISRAEL - 88'),
	array('','XX','IRAQ - 88'),
	array('','XX','IRELAND - 87'),
	...
	array('','XX','JAMAICA - 90'),
	array('','XX','JAPAN - 89'),
	array('','XX','KAMPUCHEA - 62'),
	array('','XX','KUWAIT - 88'),
	array('','XX','KENYA - 85'),
	array('','XX','KIRIBATI - 93'),
	array('','XX','KOREA (SELATAN) - 89'),
	array('','XX','KOREA (UTARA) - 89'),
	array('','XX','KAZAKHSTAN - 93'),
	array('','XX','KYRGYZSTAN - 93'),
	array('','XX','LEBANON - 88'),
	array('','XX','LUXEMBOURG - 86'),
	array('','XX','LIBYA - 93'),
	array('','XX','LATVIA - 92'),
	array('','XX','LESOTHO - 93'),
	array('','XX','LIECHTENSTEIN - 93'),
	array('','XX','LAOS - 63'),
	array('','XX','LITHUANIA - 92'),
	array('','XX','LIBERIA - 85'),
	array('','XX','LUAR NEGARA - 71,72'),
	array('','XX','MALI - 85'),
	array('','XX','MONGOLIA - 93'),
	array('','XX','MALDIVES - 93'),
	array('','XX','MAGHRIBI - 93'),
	array('','XX','MAURITANIA - 85'),
	array('','XX','MONACO - 86'),
	array('','XX','MOROCCO - 85'),
	array('','XX','MONTSERRAT - 93'),
	array('','XX','MALAWI - 85'),
	array('','XX','MICRONESIA - 83'),
	array('','XX','MALTA - 86'),
	array('','XX','MYANMAR - 64'),
	array('','XX','MADAGASCAR - 93'),
	array('','XX','MACAU - 93'),
	array('','XX','MAURITIUS - 93'),
	array('','XX','MARSHALL ISLANDS - 83'),
	array('','XX','MEKAH - 99'),
	array('','XX','MACEDONIA - 86'),
	array('','XX','MEDITERANEAN - 86'),
	array('','XX','MARTINIQUE - 90'),
	array('','XX','MEXICO - 90'),
	array('','XX','MAYOTTE - 85'),
	array('','XX','MOZAMBIQUE - 85'),
	array('','XX','MONTENEGRO - 92'),
	array('','XX','MALAGASY - 93'),
	array('','XX','MAKLUMAT TIADA - 99'),
	array('','XX','NIGER - 85'),
	array('','XX','NAMIBIA - 85'),
	array('','XX','NAURU - 93'),
	array('','XX','NETHERLANDS ANTILLES - 91'),
	array('','XX','NEW ZEALAND - 83'),
	array('','XX','NEUTRAL ZONE - 99'),
	array('','XX','NIGERIA - 85'),
	array('','XX','NEW CALEDONIA - 83'),
	array('','XX','NEPAL - 93'),
	array('','XX','NIUE - 83'),
	array('','XX','NICARAGUA - 90'),
	array('','XX','NORFOLK ISLANDS - 83'),
	array('','XX','NETHERLANDS - 86'),
	array('','XX','NORTHERN MARIANAS ISLANDS - 93'),
	array('','XX','NORWAY - 86'),
	array('','XX','OMAN - 88'),
	array('','XX','OUTER MONGOLIA - 93'),
	array('','XX','PAKISTAN - 76'),
	array('','XX','PHILIPPINES - 65'),
	array('','XX','PAPUA NEW GUINEA - 83'),
	array('','XX','POLAND - 92'),
	array('','XX','PALESTINE - 93'),
	array('','XX','PORTUGAL - 86'),
	array('','XX','PANAMA - 90'),
	array('','XX','PITCAIRN ISLANDS - 93'),
	array('','XX','PARAGUAY - 84'),
	array('','XX','PUERTO RICO - 90'),
	array('','XX','PERU - 84'),
	array('','XX','PALAU - 93'),
	array('','XX','QATAR - 88'),
	array('','XX','ROMANIA - 92'),
	array('','XX','REFUGEE - 99'),
	array('','XX','RWANDA - 85'),
	array('','XX','REP. OF MOLDOVA - 86'),
	array('','XX','REUNION - 85'),
	array('','XX','REPUBLIC OF YEMEN - 88'),
	array('','XX','RUSSIAN FEDERATION - 92'),
	array('','XX','REPUBLIC OF KOSOVO - 92'),
	array('','XX','REFUGEE ARTICLE 1/1951 - 99'),
	array('','XX','SENEGAL - 85'),
	array('','XX','SPAIN - 86'),
	array('','XX','SIERRA LEONE - 85'),
	array('','XX','SWAPO - 93'),
	array('','XX','SOMALIA - 85'),
	array('','XX','SWITZERLAND - 86'),
	array('','XX','SUDAN - 85'),
	array('','XX','ST. HELENA - 93'),
	array('','XX','SYRIA - 88'),
	array('','XX','ST. KITTS AND NEVIS - 90'),
	array('','XX','ST.LUCIA - 93'),
	array('','XX','SERBIA - 92'),
	array('','XX','ST.VICENT - 93'),
	array('','XX','SAN MARINO - 93'),
	array('','XX','SEYCHELLES - 93'),
	array('','XX','SLOVAKIA - 86'),
	array('','XX','SINGAPURA - 66'),
	array('','XX','SLOVENIA - 86'),
	array('','XX','SOLOMON ISLANDS - 93'),
	array('','XX','SOUTH GEORGIA &amp; THE SOUTH SANDWICH ISLANDS - 84'),
	array('','XX','SRI LANKA - 78'),
	array('','XX','STATELESS PERSON ARTICLE 1/1954 - 98'),
	array('','XX','SWAZILAND - 85'),
	array('','XX','SVALBARD AND JAN MAYEN ISLANDS - 93'),
	array('','XX','SAMOA - 93'),
	array('','XX','ST. PIERRE AND MIQUELON - 91'),
	array('','XX','SAO TOME &amp; PRINCIPE - 93'),
	array('','XX','ST. VINCENT AND THE GRENADINES - 90'),
	array('','XX','SAUDI ARABIA - 77'),
	array('','XX','ST. LUCIA - 90'),
	array('','XX','SURINAME - 84'),
	array('','XX','SWEDEN - 86'),
	array('','XX','SAMAO BARAT - 93'),
	array('','XX','TUNISIA - 85'),
	array('','XX','TAIWAN - 89'),
	array('','XX','TURKEY - 88'),
	array('','XX','TAJIKISTAN - 93'),
	array('','XX','TANZANIA - 85'),
	array('','XX','TURKMENISTAN - 93'),
	array('','XX','TONGA - 85'),
	array('','XX','TIMUR TENGAH - 88'),
	array('','XX','TRINIDAD &amp; TOBAGO - 90'),
	array('','XX','TIMUR JAUH - 89'),
	array('','XX','TUVALU - 93'),
	array('','XX','TIMOR LESTE - 83'),
	array('','XX','THAILAND - 67'),
	array('','XX','TOKELAU - 83'),
	array('','XX','TOGO - 85'),
	array('','XX','TURKS AND CAICOS ISLANDS - 90'),
	array('','XX','Tanpa Negara - 98'),
	array('','XX','UGANDA - 85'),
	array('','XX','UK-NATIONAL OVERSEAS - 86'),
	array('','XX','UNITED ARAB EMIRATE - 88'),
	array('','XX','UK-OVERSEAS CITIZEN - 86'),
	array('','XX','UPPER VOLTA - 93'),
	array('','XX','UK-PROTECTED PERSON - 86'),
	array('','XX','URUGUAY - 84'),
	array('','XX','UK-SUBJECT - 86'),
	array('','XX','U.S.S.R / RUSIA - 92'),
	array('','XX','UN SPECIALIZED AGENCY - 99'),
	array('','XX','UKRAINE - 92'),
	array('','XX','UNITED NATIONS ORGANIZATION - 99'),
	array('','XX','UNITED STATES OF AMERICA - 91'),
	array('','XX','UNITED STATES MINOR OUTLYING ISLANDS - 83'),
	array('','XX','UZBEKISTAN - 93'),
	array('','XX','UNSPECIFIED NATIONALITY - 99'),
	array('','XX','UK-DEPENDENT TERRITORIES CIT - 86'),
	array('','XX','VANUATU - 93'),
	array('','XX','VENEZUELA - 84'),
	array('','XX','VIETNAM - 68'),
	array('','XX','VATICAN CITY - 93'),
	array('','XX','VIRGIN ISLANDS (BRITISH) - 93'),
	array('','XX','VIRGIN ISLANDS (USA) - 90'),
	array('','XX','WALLIS AND FUTUNA ISLANDS - 83'),
	array('','XX','WESTERN SAHARA - 85'),
	array('','XX','WESTERN SAMOA - 93'),
	array('','XX','YEMEN ARAB REP. - 88'),
	array('','XX','YEMEN PEOPLE DEM.RE - 88'),
	array('','XX','YUGOSLAVIA - 93'),
	array('','XX','ZAIRE - 85'),
	array('','XX','ZAMBIA - 85'),
	array('','XX','ZIMBABWE - 85'),
);
#--------------------------------------------------------------------------------------------------
