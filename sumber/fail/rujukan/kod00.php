...
$data['pengajian'] = array(
	...
	array('','38X','Undang-undang',''),
	array('','381','381 - Undang-undang (am, antarabangsa)',''),
	array('','382','382 - Undang-undang syariah',''),
	array('','42X','Sains hayat',''),
	array('','421','421 - Biologi dan biokimia (bioteknologi, genetik, mikrobiologi, zoologi, entomologi)',''),
	array('','422','442 - Sains persekitaran (ekologi)',''),
	array('','44X','Sains fizikal',''),
	array('','441','441 - Fizik (sains fizik, astronomi, sains nuklear, optik, sains angkasa)',''),
	array('','442','442 - Kimia (kimia organik, polimer, petroleum)',''),
	array('','443','443 - Sains (earth science, atmosphere, geography (physical), geophysic, geoscience, geology, hydrologi, sains marin, oceanography, palentology, meteorology, mineralogy, seismology)',''),
	array('','46','Matematik dan statistik',''),
	array('','461','461 - Matematik (algebra, matematik gunaan, geometri, penyelidikan operasi, analisis berangka)',''),
	array('','462','462 - Statistik (teori kebarangkalian, statistik gunaan, survey sampling, survey design, sains aktuari)',''),
	array('','48','Pengkomputeran',''),
	array('','481','481 - Sains komputer (programming, programming language C++, system analysis, system design, informatics, network administration, operating system, software localisation)',''),
	array('','482','482 - Penggunaan komputer (computer software use, internet use programmes, spreadsheets, software for data processing, desktop publishing and word processing)',''),
	array('','52','Kejuruteraan dan kejuruteraan dagangan',''),
	array('','521','521 - Mekanik dan kerja logam (bicycle production, boiler, welding, gunsmithing, hydraulics, repairing, mechanical engineering, metallurgical technology, steel, precision mechanics)',''),
	array('','522','522 - Tenaga dan elektrik (air-conditioning programmes, electrical appliances repairing, fitting, engineering, power generation, gas distribution, nuclear, hydraulic and thermal energy, power production, powerline installation, refrigeration programmes, solar energy)',''),
	array('','523','523 - Elektronik dan pengautomasian (broadcasting electronics, communication systems, installation, equiment maintenance, computer engineering, repairing, control engineering, digital technologi, network technology, robotics, telecommunication technology, television and radio repairing)',''),
	array('','524','524 - Kimia dan proses (chemical engineering, laboratory technology, oil refining, oil/gas/petrochemicals processing, plant and machine operation)',''),
	array('','525','525 - Kenderaan bermotor, kapal dan kapal terbang (aeronautical/aerospace engineering, agriculture machinery, air-craft engineering, automotive engineering, helicopter / marine/ motorcycle / naval engineering, shipbuilding, vehicle and motor engineering)',''),
	array('','526','526 - Kejuruteraan awam (bridge/building construction, dock and harbour engineering, quantity surveying, road building, technical drawings, water supply and sewerage engineering)',''),
	array('','527','527 - Kejuruteraan bahan',''),
	//Pembuatan dan pemprosesan
	array('','54','Pembuatan dan pemprosesan',''),
	array('','541','541-Pemprosesan / teknologi  makanan (baking, confectionary, dairy foods, distilling, food processing, food hygiene, food preservation and packaging, pastry cooking)',''),
	array('','542','542 - Tekstil, pakaian, pakaian kaki, kulit (apparel and textile working, tailoring, dressmaking, footwear making, shoemaking, spinning)',''),
	array('','543','543 - Bahan (kayu, kertas, plastik, kaca) (boat building, cabinet making, carpentry, furniture craft, glass production, paper and plastics manufacturing, synthetic fibre manufacturing, timber technology, wood technology)',''),
	array('','544','544 - Perlombongan dan galian (coal mining, oil & gas/raw material extraction)',''),
	array('','545','545 - Sains gunaan (environmental/ marine/ polymer, plantation technology)',''),
	array('','58','Senibina dan bangunan',''),
	array('','581','581 - Senibina dan perancang bandar (architecture, cartography/land surveying, landscape, topography, urban planning)',''),
	array('','582','582 - Bangunan (bricklaying, carpentry & joinery, cement working, demolition, floor & wall tiling, glazing, plumbing, satitation, roof fixing, painting & wall covering)',''),
	array('','62','Pertanian, perhutanan dan perikanan',''),
	array('','621','621 - Pengeluaran ternakan dan tanaman (agronomy, pembiakan haiwan, farming, orchards construction, vegetable plantation)',''),
	array('','622','622 - Perkebunan (horticulture, floriculture, gardening, greenhouse, nursery management)',''),
	array('','623','623 - Perhutanan',''),
	array('','624','624 - Perikanan (akuakultur, pembiakan ikan/haiwan kerang-kerangan)',''),
	array('','64','Veterinar',''),
	array('','641','641 Penjagaan kesihatan haiwan, reproduction, veterinary assisting and medicine',''),
	array('','72','Kesihatan',''),
	array('','721','721 - Perubatan',''),
	array('','722','722 - Perkhidmatan perubatan (diagnostik, teknologi perawatan, terapi dan pemulihan, farmasi)',''),
	array('','723','723 - Kejururawatan dan penjagaan',''),
	array('','724','724 - Pengajian pergigian',''),
	array('','725','725 - Teknologi rawatan dan perubatan diagnostik (emergency para-medical technology, medical laboratory, x-ray technology, radiotherapy, hearing aid technology)',''),
	array('','726','726 - Terapi dan pemulihan (nutrisi & dietetik, urutan perubatan, kesihatan mental, optometry, refleksologi, fisioterapi)',''),
	array('','727','727 - Farmasi',''),
	array('','76','Perkhidmatan sosial',''),
	array('','761','761 - Perkhidmatan asuhan kanak-kanak dan belia',''),
	array('','762','762 - Kerja sosial dan kaunseling (career advising, social studies, kaunseling perkahwinan dan keluarga)',''),
	array('','81','Perkhidmatan personal',''),
	array('','811','811 - Hotel, restoran dan katering (seni kulinari, masakan, penyediaan makanan, perkhidmatan hospitaliti)',''),
	array('','812','812 - Pengembaraan, pelancongan dan rekreasi',''),
	array('','813','813 - Sukan (gymnastik, diving, sports coaching)',''),
	array('','814','814 - Perkhidmatan domestik (housekeeping, homeservice, laundry)',''),
	array('','815','815 - Perkhidmatan pendandanan dan kecantikan (perkhidmatan kosmetik, fitness & weight control, dandanan rambut, persolekan, manicure & pedicure, perkhidmatan salon, urutan kecantikan)',''),
	array('','84','Perkhidmatan pengangkutan',''),
	array('','840','840 - Air crew programmes, aircraft operation, aviation, cabin crew training, crane, truck & fork-lift driving, nautical science, postal service, railway operations, seamanship, ship operation',''),
	array('','85','Kawalan alam sekitar',''),
	array('','851','851 - Teknologi kawalan alam sekitar (teknologi dan kawalan pencemaran, kitar semula)',''),
	array('','852','852 - Alam semula jadi dan hidupan liar (pengurusan taman negara dan hidupan liar)',''),
	array('','853','853 - Perkhidmatan sanitari komuniti',''),
	array('','86','Perkhidmatan keselamatan',''),
	array('','861','861 - Perlindungan diri dan harta benda (security guarding, police work, fire technology, civil security)',''),
	array('','862','862 - Kesihatan dan keselamatan pekerjaan (job safety, ergonomics, kebajikan pekerja)',''),
	array('','863','863 - Ketenteraan dan pertahanan (latihan ketenteraan, sains militari, national security)',''),
);
#--------------------------------------------------------------------------------------------------
