...
<div class="col">
	...
	<div class="row">
		<div class="col-sm-3">
		<a class="btn btn-secondary text-white" href="<?php echo URL ?>index/privasi/">
			Dasar Privasi / Privacy Policy</a>&nbsp;
		<a class="btn btn-secondary text-white" href="<?php echo URL ?>hubungi/mediasosial">
			Media Sosial</a>
		...
		<div class="col-sm-7" style="background-color:white;text-align:justify;">
			...
			lagipun website saya ini amat popular, cuma blog saya aje kurang popular.
